...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <!-- Earnings (Monthly) Card Example -->
        <div class="col-xl-3 col-md-6 mb-4"@if(Auth::User()->role_as == 'admin' or  Auth::User()->role_as =='user' or Auth::User()->role_as =='provider' ) style="display: none" @endif >
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                            Total Handyman</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$handyman}}</div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-comments fa-2x text-gray-300"></i>
                        </div>
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <!-- Earnings (Monthly) Card Example -->
        <div class="col-xl-3 col-md-6 mb-4"@if(Auth::User()->role_as == 'admin' or  Auth::User()->role_as =='hand' or Auth::User()->role_as =='provider' ) style="display: none" @endif >
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
        ...
        <!-- Earnings (Monthly) Card Example -->
        <div class="col-xl-3 col-md-6 mb-4"@if(Auth::User()->role_as == 'admin' or  Auth::User()->role_as =='handyman' or Auth::User()->role_as =='provider' ) style="display: none" @endif>
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
